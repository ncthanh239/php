    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Quản Lí Bán Hàng</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="employees.php"><i class="fa fa-dashboard fa-fw"></i> Quản Lí Nhân Viên</a>
                        </li>
                        <li>
                            <a href="customers.php"><i class="fa fa-bar-chart-o fa-fw"></i> Quản Lí Khách Hàng</a>
                           
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="products.php"><i class="fa fa-table fa-fw"></i> Quản Lí Sản Phẩm</a>
                        </li>

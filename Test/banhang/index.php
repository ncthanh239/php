...
<body>
	<div class="container">
		...
		<a href="cart.php" class="btn btn-success">Danh sách sản phẩm trong giỏ hàng >></a>
		<table class="table table-hover">
			<tr>
				...
				<tr>
					...
					<td align="center"><a href="add2cart.php?code=<?= $product[0] ?>" class="btn btn-primary">Add to cart</a></td>
				</tr>

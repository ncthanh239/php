            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="quanLiBaiViet.php"><i class="fa fa-dashboard fa-fw"></i> Quản Lí Bài Viết</a>
                        </li>
                        <li>
                            <a href="quanLiNguoiDung.php"><i class="fa fa-bar-chart-o fa-fw"></i> Quản Lí Người Dùng</a>
                           
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="quanLiTag.php"><i class="fa fa-table fa-fw"></i> Quản Lí Tags</a>
                        </li>
